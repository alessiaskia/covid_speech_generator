    ...
    <blockquote>
        ...
        switch ($deuxiemePhrase) {
            case '0':
                ...
                break;
            case '1':
                echo "<p>Nous devons tenir, chacun à notre place, dans la transparence, le débat, sans oublier que - et je me dirige par là spécifiquement aux citoyens travaillant dans les domaines non essentiels - il y aura toujours des voix qui comptent plus et d'autres moins. Je vous invite donc, mes chers concitoyens, à ne pas oublier quelle est votre place.</p>";
                break;
            case '2':
                echo "<p>Mais aujourd'hui, la crise du coronavirus nous fait enfin prendre conscience de la profondeur <br /> du changement qui sera nécessaire: nous devons transformer notre mode de vie et cela veut dire que t'as de la chance si tu as un partenaire maintenant, tu t'éviteras une grosse crise d'abstinence et tu sauras faire face à la deprime, alors que tant pis pour les autres, ciao ciao Tinder, soirées, bars et toute autre moyen moderne de draguer.</p>";
                break;
            case '3':
                echo "<p>Nous devons impérativement continuer à respecter les règles difficiles de confinement et distanciation sociale,<br />y compris durant cette période de retour du mauvais temps, où vous serez obligés de marcher dans les parcs sous la pluie, la grêle, dans la boue si vous voulez voir vos amis et famille, alors que vous voudriez juste rester bien enfoncé(e)s dans vos canaps avec votre thé et biscuits.</p>";
                break;
        }
        switch ($troixiemePhrase) {
            case '0':
                ...
                break;
            case '1':
                echo "<p>Nous avons besoin les uns des autres, nous sommes une nation unie et solidaire et c’est à cette condition que nous y arriverons, bien que personne ne sache quand il faudra arrêter de stocker des montagnes de papier toilette.</p>";
                break;
            case '2':
